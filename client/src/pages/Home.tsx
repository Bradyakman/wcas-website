  ...
  return (
    <div style={{ fontFamily: SERIF, background: BG, color: TEXT, minHeight: "100vh" }}>
      ...
      <section style={{ padding: 0, background: "#152238" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "48px 48px 32px" }}>
        ...
        <style>{`
          ...
          .wwi-content { position:relative; z-index:2; padding:0 48px 40px; transition:opacity 0.3s ease; text-align:left; }
