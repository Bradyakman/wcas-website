  ...
  return (
    <div style={{ fontFamily: SERIF, background: BG, color: TEXT, minHeight: "100vh" }}>
      ...
      <section className="hero-section" style={{ position: "relative", overflow: "hidden", backgroundImage: `url(${heroBg})`, backgroundSize: "cover", backgroundPosition: "center right", backgroundRepeat: "no-repeat" }}>
        <div className="hero-content-scrim" style={{ position: "relative", zIndex: 2, padding: "220px 56px 48px", maxWidth: 1400 }}>
          ...
          <div style={{ marginTop: 36, display: "flex", gap: 16 }}>
            <a href="/portfolio" className="pill-btn" style={{ fontFamily: SANS, fontSize: 15, fontWeight: 500, padding: "12px 32px", borderRadius: 23, border: "1px solid rgba(255,255,255,0.3)", background: "rgba(255,255,255,0.08)", color: "rgba(255,255,255,0.9)", cursor: "pointer", textDecoration: "none" }}>Explore Our Portfolio</a>
      ...
      <section style={{ padding: 0, background: "#152238" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "85px 56px 0" }}>
        ...
        <style>{`
          ...
          .wwi-watermark { position:absolute; top:40px; left:48px; font-family:'Cormorant Garamond',serif; font-size:88px; font-weight:300; color:rgba(255,255,255,0.55); line-height:1; pointer-events:none; z-index:1; }
      ...
      {/* ── PORTFOLIO ── */}
      <section style={{ background: "#0c1a2e", padding: "85px 56px" }}>
        <style>{`
      ...
      <section style={{ position: "relative", overflow: "hidden", background: "#152238", marginTop: 0 }}>
        ...
        `}</style>
        <div style={{ position: "relative", zIndex: 10, padding: "85px 56px 85px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 48 }}>
            <div style={{ flex: 1 }}>
      ...
      {/* ── NEWS ── */}
      <section style={{ background: "#f4f3f0", padding: "85px 56px" }}>
        <style>{`
