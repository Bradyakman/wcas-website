...
const heroSlides = [
  {
    title: (
      <>Supporting innovation and growth in <span className="bg-white/15 px-1 rounded" style={{lineHeight: 'inherit', paddingTop: 0, paddingBottom: 0}}>Technology</span> and <span className="bg-white/15 px-1 rounded" style={{lineHeight: 'inherit', paddingTop: 0, paddingBottom: 0}}>Healthcare</span></>
    ),
