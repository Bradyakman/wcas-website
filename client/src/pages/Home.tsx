    ...
    <div style={{ fontFamily: SERIF, background: BG, color: TEXT, minHeight: "100vh" }}>
      ...
      <section className="hero-section" style={{ position: "relative", overflow: "hidden", backgroundImage: `url(${heroBg})`, backgroundSize: "cover", backgroundPosition: "center right", backgroundRepeat: "no-repeat" }}>
        <div className="hero-content-scrim" style={{ position: "relative", zIndex: 2, padding: "220px 56px 48px", maxWidth: 1100 }}>
          ...
          <p style={{ fontFamily: SANS, fontSize: 23, color: "rgba(255,255,255,0.8)", lineHeight: 1.7, fontWeight: 300, maxWidth: 900, textShadow: "0 1px 2px rgba(0,0,0,0.2)" }}>
          ...
          <div style={{ marginTop: 36, display: "flex", gap: 16 }}>
            <a href="/portfolio" className="pill-btn" style={{ fontFamily: SANS, fontSize: 13, fontWeight: 500, padding: "10px 28px", borderRadius: 20, border: "1px solid rgba(255,255,255,0.15)", background: "rgba(255,255,255,0.04)", color: "rgba(255,255,255,0.7)", cursor: "pointer", textDecoration: "none" }}>Explore Our Portfolio</a>
