...
export default function Home() {
  ...
  return (
    <div className="w-full">
      {/* Hero Section */}
      <section className="relative min-h-[55vh] md:min-h-[70vh] flex items-end pt-24 pb-12 overflow-hidden">
        <div 
          ...
          <div className="max-w-5xl relative">
            ...
            <div className="pb-32 md:pb-32 lg:pb-40 xl:pb-32">
              <div className="flex flex-col justify-center">
                <h1 className="text-3xl md:text-4xl lg:text-4xl xl:text-[56px] font-heading font-extrabold text-white leading-[1.1] tracking-tighter">
                  {heroSlides[0].title}
                </h1>
              </div>
            </div>
