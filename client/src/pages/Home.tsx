    ...
    <div style={{ fontFamily: SANS, background: BG, color: TEXT, minHeight: "100vh" }}>
      ...
      <section style={{
        ...
        <div style={{ display: "flex", gap: 14, justifyContent: "center", padding: "0 48px 28px" }}>
          <a href="#" onClick={e=>e.preventDefault()} className="pill-btn hero-pill-btn" style={{ fontFamily: SANS, fontSize: 14, fontWeight: 500, padding: "11px 0", width: 200, textAlign: "center", borderRadius: 23, border: "1px solid #22c55e", background: "#22c55e", color: "#fff", cursor: "pointer", textDecoration: "none" }}>Our Story</a>
