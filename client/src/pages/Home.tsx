      ...
      <section className="relative min-h-[34vh] md:min-h-[44vh] flex items-center pt-24 pb-8 overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10 flex items-center justify-center h-full">
          <div className="pb-40 md:pb-44 lg:pb-48 xl:pb-44 flex flex-col items-center text-center">
            ...
            <h1 className="text-[1.26rem] md:text-[1.575rem] font-bold text-white leading-[1.3] tracking-normal max-w-4xl" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>
              {heroSlides[0].title}
            </h1>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10">
            ...
            <div className="group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500 relative overflow-hidden flex flex-col">
              ...
              <div className="py-6 md:py-8 px-10 md:px-12 flex-grow flex items-center justify-center bg-primary">
                <h4 className="text-3xl md:text-4xl font-heading font-bold text-white">Healthcare</h4>
              </div>
            </div>
            ...
            <div className="group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500 relative overflow-hidden flex flex-col">
              ...
              <div className="py-6 md:py-8 px-10 md:px-12 flex-grow flex items-center justify-center bg-primary">
                <h4 className="text-3xl md:text-4xl font-heading font-bold text-white">Technology</h4>
              </div>
            </div>
