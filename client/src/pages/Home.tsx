    ...
    <div style={{ fontFamily: SERIF, background: BG, color: TEXT, minHeight: "100vh" }}>
      ...
      <section style={{ padding: 0, background: "#152238" }}>
        <style>{`
          ...
          .wwi-watermark { position:absolute; top:40px; left:48px; font-family:'Cormorant Garamond',serif; font-size:88px; font-weight:300; color:rgba(255,255,255,0.25); line-height:1; pointer-events:none; animation:wwi-shimmer 4s ease-in-out infinite; transition:color 0.4s, transform 0.4s; z-index:1; }
          .wwi-pnl:hover .wwi-watermark { animation:none; color:rgba(255,255,255,0.45); transform:translateY(-6px); }
