...
const companies: Company[] = [
  ...
  { name: "LINQ", sector: "Technology", color: "#4f46e5", status: "current", logo: "/logos/linq.png", darkBg: true },
  ...
  { name: "AssistRx", sector: "Healthcare", color: "#4db6ac", status: "current", logo: "/logos/assistrx.png" },
  { name: "Constitution", sector: "Healthcare", color: "#1a8cba", status: "current", logo: "/logos/constitution.png" },
...
export default function PortfolioPage() {
  ...
  return (
    <div style={{ fontFamily: SERIF, background: "#fff", color: "#111", minHeight: "100vh" }}>
      ...
      <section style={{ position: "relative", overflow: "hidden", width: "100%", minHeight: 575, background: "radial-gradient(ellipse 60% 50% at 85% 90%, rgba(20,60,80,0.25) 0%, transparent 70%), radial-gradient(ellipse 80% 60% at 72% 80%, #0d3a4a55 0%, transparent 70%), radial-gradient(ellipse 50% 50% at 60% 50%, #0a2a3a22 0%, transparent 60%), linear-gradient(135deg, #060d18 0%, #091520 40%, #0b2030 70%, #0a1e32 100%)" }}>
