  ...
  return (
    <div style={{ fontFamily: SERIF, background: "#fff", color: "#111", minHeight: "100vh" }}>
      ...
      <section style={{ position: "relative", overflow: "hidden", width: "100%", minHeight: 575, background: "#060f1c" }}>
        <div style={{ position: "absolute", inset: 0, backgroundImage: "url(/logos/portfolio-hero-bg2.png)", backgroundSize: "cover", backgroundPosition: "center center", backgroundRepeat: "no-repeat" }} />
