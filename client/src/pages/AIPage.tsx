...
const caseStudies = [
  { company: "Norstella", sector: "Healthcare", app: "NorstellaLinQ Trial Design Co-Pilot", useCase: "GenAI + ML powered data and tools supporting clinical trial design and optimization.", build: "Built internally leveraging large multimodal data set.", logo: norstellaWhiteLogo, logoH: 60, cardImg: "/logos/norstella-ai-card.png" },
