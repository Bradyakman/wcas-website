...
const caseStudies = [
  ...
  { company: "AllazoHealth", sector: "Healthcare", app: "AssistRx Add-On Patient Engagement", useCase: "AI-powered platform predicts adherence risk and personalizes outreach.", build: "Acquired via AllazoHealth.", cardImg: "/logos/allazo-ai-card-new.png", logo: "/logos/assistrx-transparent.png", logoH: 50 },
...
export default function WCASAIPage() {
  ...
  return (
    <div style={{ fontFamily: SERIF, background: BG, color: "#E4E8ED", minHeight: "100vh" }}>
      ...
      {/* HERO */}
      <section id="about" style={{ position: "relative", overflow: "hidden", background: "#041a2e", display: "flex", flexDirection: "column" }}>
        {/* Radial glow overlay */}
        ...
        <div style={{ flex: 1, minHeight: 453, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "44px 48px", position: "relative", zIndex: 1 }}>
          <h1 style={{ fontFamily: SANS, fontSize: 36, fontWeight: 400, lineHeight: 1.35, color: "#fff", margin: "0 0 28px" }}>Where <em style={{ fontStyle: "italic", fontWeight: 400, color: "#8BBDE8" }}>Sector Expertise</em> Meets <em style={{ fontStyle: "italic", fontWeight: 400, color: "#8BBDE8" }}>Artificial Intelligence</em></h1>
          <Fade><p style={{ fontFamily: SANS, fontSize: 16, fontWeight: 400, color: "rgba(255,255,255,0.75)", lineHeight: 1.55, maxWidth: 820, margin: "0 0 32px" }}>At WCAS, AI isn't a theme. It's infrastructure, embedded in how we evaluate investments, how we support our portfolio, and how we create lasting value.</p></Fade>
