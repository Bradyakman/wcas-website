...
export default function WCASAIPage() {
  ...
  return (
    <div style={{ fontFamily: SERIF, background: BG, color: "#E4E8ED", minHeight: "100vh" }}>
      ...
      {/* HERO */}
      <section id="about" style={{ position: "relative", overflow: "hidden", background: "#041a2e", display: "flex", flexDirection: "column", minHeight: 480 }}>
        {/* Radial glow overlay */}
        <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: 600, height: 400, background: "radial-gradient(ellipse, rgba(20,100,90,0.45) 0%, rgba(4,26,46,0) 70%)", pointerEvents: "none", zIndex: 0 }} />
        {/* Nav spacer */}
        <div style={{ height: 52, flexShrink: 0 }} />
        {/* Centered content */}
        <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "40px 48px", position: "relative", zIndex: 1 }}>
          <h1 style={{ fontFamily: SANS, fontSize: 32, fontWeight: 400, lineHeight: 1.35, color: "#fff", margin: "0 0 28px" }}>Where <em style={{ fontStyle: "italic", fontWeight: 400, color: "#8BBDE8" }}>Sector Expertise</em> Meets <em style={{ fontStyle: "italic", fontWeight: 400, color: "#8BBDE8" }}>Artificial Intelligence</em></h1>
          <Fade><p style={{ fontFamily: SANS, fontSize: 20, fontWeight: 400, color: "rgba(255,255,255,0.75)", lineHeight: 1.55, maxWidth: 820, margin: "0 0 40px" }}>At WCAS, AI isn't a theme. It's infrastructure, embedded in how we evaluate investments, how we support our portfolio, and how we create lasting value.</p></Fade>
          <div style={{ display: "flex", gap: 14, justifyContent: "center" }}>
            <a href="#case-studies" className="pill-btn hero-pill-btn" style={{ fontFamily: SANS, fontSize: 14, fontWeight: 500, padding: "11px 0", width: 220, textAlign: "center", borderRadius: 23, border: "1px solid rgba(255,255,255,0.25)", background: "rgba(255,255,255,0.07)", color: "rgba(255,255,255,0.85)", cursor: "pointer", textDecoration: "none", display: "inline-block" }}>Portfolio Case Studies</a>
            <a href="#playbook" className="pill-btn hero-pill-btn" style={{ fontFamily: SANS, fontSize: 14, fontWeight: 500, padding: "11px 0", width: 220, textAlign: "center", borderRadius: 23, border: "1px solid rgba(255,255,255,0.25)", background: "rgba(255,255,255,0.07)", color: "rgba(255,255,255,0.85)", cursor: "pointer", textDecoration: "none", display: "inline-block" }}>Our Playbook</a>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: "#fff", padding: "56px 24px" }}>
        ...
        <p style={{ fontFamily: SANS, fontSize: 13, color: "#555", lineHeight: 1.85, textAlign: "center", maxWidth: 680, margin: "0 auto" }}>
        ...
        <div style={{ position: "relative", zIndex: 2 }}>
          ...
          <Fade delay={100}>
            <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", marginTop: 48 }}>
              {scaleSteps.map((s, i) => (
                <div key={i} className="pb-row" style={{ display: "grid", gridTemplateColumns: "310px 1fr", gap: 32, alignItems: "start", padding: "32px 0", borderBottom: "1px solid rgba(255,255,255,0.06)", transition: "background 0.3s ease, padding-left 0.3s ease", borderRadius: 4, cursor: "default" }}>
                  <div>
