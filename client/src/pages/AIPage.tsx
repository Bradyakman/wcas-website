...
const caseStudies = [
  ...
  { company: "AIA Contract Documents", sector: "Technology", app: "Contract Review", useCase: "AI automates contract risk review and improves risk detection.", build: "Roadmap contemplates internal build or acquisition.", cardImg: "/logos/aia-ai-card.png", logo: "/logos/aia-logo-clean.png", logoH: 75, logoBlend: true },
];
                    ...
                    <div className="cs-flip-front" style={{ background: (cs as any).cardImg ? `linear-gradient(180deg, rgba(8,14,28,0.5) 0%, rgba(8,14,28,0.9) 100%), url(${(cs as any).cardImg}) center/cover no-repeat` : "rgba(8,14,28,0.7)", border: `1px solid rgba(255,255,255,0.06)`, borderRadius: 16, padding: "32px 28px", display: "flex", flexDirection: "column", justifyContent: (cs as any).cardImg ? "center" : "space-between", alignItems: (cs as any).cardImg ? "center" : "stretch", height: "100%", position: "relative", backdropFilter: "blur(12px)" }}>
                      {(cs as any).cardImg ? (<>
                        <div style={{ textAlign: "center" }}>
                          {(cs as any).logo && <img src={(cs as any).logo} alt={cs.company} style={{ height: (cs as any).logoH || 32, objectFit: "contain", ...((cs as any).logoBlend ? { filter: "invert(1)", mixBlendMode: "screen" as const } : { filter: "brightness(0) invert(1)" }) }} />}
                        </div>
