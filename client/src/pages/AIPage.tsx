  ...
  return (
    <div style={{ fontFamily: SERIF, background: BG, color: "#E4E8ED", minHeight: "100vh" }}>
      ...
      <section id="about" style={{ position: "relative", overflow: "hidden", background: "#041a2e", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ flex: 1, minHeight: 453, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "44px 48px 64px", position: "relative", zIndex: 1 }}>
