    ...
    <div style={{ fontFamily: SERIF, background: BG, color: "#E4E8ED", minHeight: "100vh" }}>
      ...
      <section style={{ position: "relative", overflow: "hidden", width: "100%", minHeight: 575 }}>
        ...
        <div style={{ position: "relative", zIndex: 2, padding: "220px 56px 24px" }}>
          ...
          <p style={{ fontFamily: SANS, fontSize: 18, color: "rgba(255,255,255,0.6)", lineHeight: 1.75, maxWidth: 920, fontWeight: 300, marginBottom: 56 }}>At WCAS, AI isn't a theme. It's infrastructure, embedded in how we invest, operate, and create value.</p>
