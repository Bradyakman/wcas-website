  ...
  return (
    <div style={{ fontFamily: SERIF, background: BG, color: "#E4E8ED", minHeight: "100vh" }}>
      ...
      <section style={{ background: "#fff", padding: "56px 24px" }}>
        <p style={{ fontFamily: "'Georgia', serif", fontSize: 18, color: "#0a1a3a", lineHeight: 1.7, marginBottom: 20, textAlign: "center", maxWidth: 640, margin: "0 auto 20px" }}>
        ...
        <p style={{ fontFamily: SANS, fontSize: 13, color: "#555", lineHeight: 1.85, textAlign: "center", maxWidth: 640, margin: "0 auto" }}>
