    ...
    <div style={{ fontFamily: SERIF, background: BG, color: "#E4E8ED", minHeight: "100vh" }}>
      ...
      <section style={{ position: "relative", overflow: "hidden", width: "100%", minHeight: 575 }}>
        ...
        <div style={{ position: "relative", zIndex: 2, padding: "280px 64px 24px" }}>
          ...
          <p style={{ fontFamily: SANS, fontSize: 19, color: "rgba(255,255,255,0.8)", lineHeight: 1.7, fontWeight: 300, marginBottom: 40 }}>At WCAS, AI isn't a theme. It's infrastructure, embedded in how we evaluate investments, how we support our portfolio, and how we create lasting value.</p>
