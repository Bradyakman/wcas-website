...
const scaleSteps = [
  ...
  { title: "Repository", desc: "We\u2019ve built a living registry of 300+ AI applications impacting front-office and back-office efforts, each tracked with scope, success metrics, and replicability scores across the portfolio.", stat: "300+", detail: "AI use cases catalogued", icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14c0 1.66 4.03 3 9 3s9-1.34 9-3V5"/><path d="M3 12c0 1.66 4.03 3 9 3s9-1.34 9-3"/></svg> },
  ...
  { title: "Roundtables", desc: "Monthly AI roundtables where portfolio company leaders share playbooks \u2014 wins and pitfalls. We publish repeatable frameworks, required guardrails, and feed learnings back into the repository.", stat: "Monthly", detail: "Cross-portfolio knowledge sharing", icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> },
...
const caseStudies = [
  { company: "Absorb", sector: "Technology", app: "Course Generation", useCase: "GenAI features to build, adapt, and personalize Absorb LMS learning content.", build: "Internally built with cloud-native functionality.", cardImg: "/logos/absorb-ai-card.png", logo: "/logos/absorb-white.png", logoH: 70 },
  { company: "AIA Contract Documents", sector: "Technology", app: "Contract Review", useCase: "AI automates contract risk review and improves risk detection.", build: "Roadmap contemplates internal build or acquisition.", cardImg: "/logos/aia-ai-card.png", logo: "/logos/aia-logo-v2.png", logoH: 55 },
  { company: "AllazoHealth", sector: "Healthcare", app: "AssistRx Add-On Patient Engagement", useCase: "AI-powered platform predicts adherence risk and personalizes outreach.", build: "Acquired via AssistRx.", cardImg: "/logos/allazo-ai-card.png", logo: "/logos/assistrx-transparent.png", logoH: 50 },
