    ...
    <div style={{ fontFamily: SERIF, background: BG, color: "#E4E8ED", minHeight: "100vh" }}>
      ...
      <section style={{ background: "#fff", padding: "48px 64px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "start" }}>
          <p style={{ fontFamily: "'Georgia', serif", fontSize: 16, color: "#0a1a3a", lineHeight: 1.75, margin: 0 }}>
          ...
          <p style={{ fontFamily: SANS, fontSize: 16, color: "#0a1a3a", lineHeight: 1.85, margin: 0, paddingTop: 4 }}>
