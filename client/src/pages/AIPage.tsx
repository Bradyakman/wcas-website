...
export default function WCASAIPage() {
  ...
  return (
    <div style={{ fontFamily: SERIF, background: BG, color: "#E4E8ED", minHeight: "100vh" }}>
      ...
      {/* CASE STUDIES */}
      <section id="case-studies" className="ai-case-studies" style={{ background: "#0a1f44", padding: "56px 64px 28px", position: "relative", overflow: "hidden", scrollMarginTop: 60 }}>
      ...
      {/* PLAYBOOK */}
      <section id="playbook" className="ai-playbook" style={{ background: "#0a1f44", padding: "56px 64px", position: "relative", overflow: "hidden", scrollMarginTop: 60 }}>
