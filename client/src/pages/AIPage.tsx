  ...
  return (
    <div style={{ fontFamily: SERIF, background: BG, color: "#E4E8ED", minHeight: "100vh" }}>
      <style>{`
        ...
        .ap{font-family:${SANS};font-size:15px;font-weight:500;padding:12px 32px;border-radius:23px;border:1px solid rgba(255,255,255,0.15);background:rgba(255,255,255,0.04);color:rgba(255,255,255,0.7);cursor:pointer;transition:all 0.3s;text-decoration:none;white-space:nowrap}.ap:hover{color:#fff;border-color:rgba(255,255,255,0.25);background:rgba(255,255,255,0.08)}.ap.ac{color:#fff;border-color:rgba(255,255,255,0.25);background:rgba(255,255,255,0.1)}
